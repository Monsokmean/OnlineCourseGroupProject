        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(user_name.isEmpty()){
                    ...
                    registerPB.setVisibility(View.VISIBLE);
                    Boolean insertOrNot = dbHelper.RegisterUserLogin(user_name,user_pass);

                    if (insertOrNot == true){
                        registerPB.setVisibility(View.GONE);
                        Toast.makeText(Register_page.this, "New User Inserted", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(Register_page.this,LoginActivity.class));
                        finish();

                    }else{
                        registerPB.setVisibility(View.GONE);
                        Toast.makeText(Register_page.this, "Fail to insert user", Toast.LENGTH_SHORT).show();
